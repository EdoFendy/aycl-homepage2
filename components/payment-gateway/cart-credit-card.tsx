...
export default function CartCreditCardGateway({ order }: PaymentGatewayProps) {
  ...
  async function handleCheckout() {
    ...
    try {
      const response = await fetch("/api/cart/payment-link", {
        method: "POST",
        headers: {
    ...
    <div className="mt-6 space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="space-y-1">
          <Label htmlFor="cart-checkout-first-name" className="text-xs uppercase tracking-[0.25em] text-gray-400">
            {t("payment.form.firstName")}
          </Label>
          <Input
            id="cart-checkout-first-name"
            value={firstName}
        ...
        <div className="space-y-1">
          <Label htmlFor="cart-checkout-last-name" className="text-xs uppercase tracking-[0.25em] text-gray-400">
            {t("payment.form.lastName")}
          </Label>
          <Input
            id="cart-checkout-last-name"
            value={lastName}
        ...
        <div className="space-y-1 sm:col-span-2">
          <Label htmlFor="cart-checkout-email" className="text-xs uppercase tracking-[0.25em] text-gray-400">
